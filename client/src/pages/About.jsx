    ...
    <div className='min-h-screen bg-gray-400 py-5 px-6'>
            <div className='max-w-5xl mx-auto text-center pb-4'>
                ...
                <p className='text-lg sm:text-xl text-gray-700'>
                    Welcome to <a href='/' className='font-bold'>MindBuddy</a>, your personal mental wellness companion. We understand that emotional health is just as important as physical health and we've built a safe, supportive space to help you reflect, recharge, and reconnect.
                </p>
            </div>
